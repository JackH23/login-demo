  ...
  return (
    ...
    >
      ...
      >
          <div
            className={`blog-card__layout ${
              showConversation && !isMobile ? "blog-card__layout--split" : ""
            }`}
          >
            <div className="blog-card__main-stack">
              <p
            ...
            {showConversation &&
              (!isMobile ? (
                <div
                  className={`blog-card__conversation-drawer ${
                    showConversation ? "is-visible" : ""
                  }`}
                  aria-live="polite"
                >
                  {conversationSection}
      ...
      <style jsx>{`
        ...
        .blog-card__main-stack {
          flex: 1 1 auto;
          min-width: 0;
        }

        .blog-card__conversation-drawer {
          position: relative;
          flex: 0 0 100%;
          max-width: 100%;
        ...
        @media (min-width: 768px) {
          ...
          .blog-card__layout--split {
            padding-right: clamp(280px, 36%, 420px);
          }

          .blog-card__conversation-drawer.is-visible {
            transform: translateX(0);
            opacity: 1;
            pointer-events: auto;
            filter: drop-shadow(
              0 16px 38px ${isNight ? "rgba(0,0,0,0.45)" : "rgba(15,23,42,0.12)"}
            );
          }

          .blog-card__conversation-drawer .conversation-card {
            height: 100%;
            overflow-y: auto;
            margin-top: 0;
          }
